...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if($_SESSION['isChildAccount'] == 1){
        $sql = "SELECT * FROM watch_lists as wl JOIN movies as m ON wl.movieId = m.id WHERE profileId = " . $_POST['profileId'] . " AND isMature = 0 ORDER BY wl.id DESC LIMIT 30 OFFSET " . $_POST['page'] * 30;
    }
    else{
